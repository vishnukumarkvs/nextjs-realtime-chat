            ...
            <div class="px-10 pt-4 pb-8 bg-white rounded-tr-4xl">
              ...
              <form class="mt-12" action="" method="POST">
                ...
                <input
                  ...
                  class="mt-10 px-4 py-2 rounded bg-rose-500 hover:bg-rose-400 text-white font-semibold text-center block w-full focus:outline-none focus:ring focus:ring-offset-2 focus:ring-rose-500 focus:ring-opacity-80 cursor-pointer"
                />
              </form>
              <a
                href="#"
